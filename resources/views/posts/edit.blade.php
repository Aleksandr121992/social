                ...
                <div class="card-body"> 
                   ...
                   'multipart/form-data'>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="post_title" type="input" class="form-control{{ $errors->has('post_title') ? ' is-invalid' : '' }}" name="post_title" value="{{$posts->post_title}}"  autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <textarea id="post_description" rows="7" class="form-control{{ $errors->has('post_description') ? ' is-invalid' : '' }}" name="post_description" > {{$posts->post_description}}
                                </textarea>
